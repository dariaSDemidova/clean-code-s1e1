...
var createNewTaskElement = function (taskString) {
  ...
  label.classList.add("task", "tasks__label");

  //Each elements, needs appending
  checkBox.type = "checkbox";
  checkBox.classList.add("tasks__checkbox");
  editInput.type = "text";
  editInput.classList.add("task", "tasks__input");

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.classList.add("edit", "tasks__button");

  deleteButton.classList.add("delete", "tasks__button");
  deleteButtonImg.src = "./remove.svg";
  deleteButton.appendChild(deleteButtonImg);
  deleteButtonImg.classList.add("tasks__button-image");
